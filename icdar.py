...
def load_annoataion(p):
    ...
    with open(p, 'r') as f:
        ...
        for line in reader:
            ...
            # text_polys.append([[x1, y1], [x4, y4], [x2, y2], [x3, y3]])  ### top-left-x, top-left-y, top-right-x, top-right-y, bottom-right-x, bottom-right-y, bottom-left-x, bottom-left-y
...
def check_and_validate_polys(polys, tags, xxx_todo_changeme):
    ...
    validated_polys_array = np.array(validated_polys)
    validated_tags_array = np.array(validated_tags)
    return validated_polys_array, validated_tags_array
    ...
    while True:
        ...
        for i in index:
            try:
                ...
                txt_fn = txt_fn.replace(os.path.basename(txt_fn).split('.')[0], 'gt_'+str(os.path.basename(txt_fn).split('.')[0]))
